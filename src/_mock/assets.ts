...
export const _productNames = [
  'Rafael Musi Baila La Macarena',
  'Neodaten $2.2B Seed Round',
  'Pelea a muerte entre Villa y Yony',
  'Leon nuevo hombre mas rico de Mexico',
  'Waka Waka vuelve a tendencias',
  'El chicharron de Ebrad',
  'Barbie',
];
