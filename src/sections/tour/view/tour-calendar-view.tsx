...
// API
import { getPosts, mapPostsToCalendarEvents } from 'src/api/get-posts';
...
export default function CalendarView() {
  ...
  useEffect(() => {
    const fetchAndMapPosts = async () => {
      try {
        // Replace with actual postDetails
        const postDetails = {
          status: 'pending',
          // other query parameters
        };

        const posts = await getPosts(postDetails);
        const mappedEvents = mapPostsToCalendarEvents(posts);
        ...
        <Card>
          <StyledCalendar>
            ...
            <Calendar
              ...
              dayMaxEventRows={3}
              eventDisplay="block"
              events={dataFiltered.concat(calendarEvents)}
              headerToolbar={false}
