    ...
    <>
      ...
      <Stack spacing={3} direction="row" flexWrap="wrap" alignItems="center">
        ...
        <Stack direction="row" alignItems="center" spacing={0.5} sx={{ typography: 'subtitle2' }}>
          ...
          {tourGuides?.map((tourGuide : ITourGuide) => tourGuide.name).join(', ')}
        </Stack>
      </Stack>
    </>
  );
  ...
  const renderOverview = (
    ...
    >
      {[
        ...
        {
          label: 'Contact name',
          value: tourGuides?.map((tourGuide: ITourGuide ) => tourGuide.phoneNumber).join(', '),
        ...
        {
          label: 'Contact phone',
          value: tourGuides?.map((tourGuide: ITourGuide) => tourGuide.name).join(', '),
