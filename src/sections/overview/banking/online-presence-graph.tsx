...
export default function OnlinePresenceGraph({ title, subheader, chart, ...other }: Props) {
            ...
            <Box sx={{ p: 3, pb: 1, position: 'relative' }}>
                ...
                <Box sx={{ position: 'absolute', bottom: 8, right: 8 }}>
                    ...
                    <Dialog open={openDialog} onClose={handleCloseDialog}>
                        ...
                        <DialogContent>
                            <DialogContentText>
                                Aquí vamos a agregar aun ams informacion para que los pendejos del heraldo no la caguen.
                            </DialogContentText>
                        </DialogContent>
                        <DialogActions>
