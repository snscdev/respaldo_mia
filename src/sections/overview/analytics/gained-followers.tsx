...
export default function GainedFollowers({
  title,
  total,
  percent,
  color = 'primary',
  ...
  return (
    <Stack
      sx={{
        ...
        boxShadow: theme.shadows[4], // Agregando sombra aquí.
        ...sx,
      }}
      {...other}
    >
      ...
      <Chart type="line" series={[{ data: series }]} options={chartOptions} height={80} />
    </Stack>
  );
}
